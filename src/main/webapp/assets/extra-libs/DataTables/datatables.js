...
(function( $, window, document, undefined ) {
	...
	{
		/**
		 * Perform a jQuery selector controller on the table's TR elements (from the tbody) and
	...
	DataTable.defaults = {
		 ...
		 * about filtered data if that controller is being performed.
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Features
		...
		"oLanguage": {
			...
			/**
			 * Detail the controller that will be taken when the drop down menu for the
			...
			/**
			 * Text which is displayed when the table is processing a user controller
			 ...
			 * the example language files to see how this works in controller.
			 *  @type string
	...
	DataTable.defaults.column = {
		 ...
		 *   data directly from it. This controller has effects on two other
